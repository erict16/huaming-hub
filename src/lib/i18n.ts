...
const en = {
  ...
  home: {
    ...
    title: "OLTC / DETC documents & series",
    lead: "Leaflets, data sheets, and manuals. PDFs on the international site.",
    ctaDocs: "Browse documents",
    ctaProducts: "Product series",
    ctaSelector: "Selector",
    docsBandTitle: "Documents",
    docsBandDesc: (n: number) =>
      `${n} PDFs — leaflets, data sheets, manuals. Filter by model on the docs page.`,
    docsBandCta: "Open docs",
    seriesTitle: "Product series",
    seriesCta: "All series",
    selectorStripTitle: "Selector",
    selectorStripDesc: "Voltage & current → catalogue type. First-pass only.",
    selectorStripCta: "Open tool",
...
const zh = {
  ...
  home: {
    kicker: "非官方 · 华明",
    title: "有载 / 无励磁分接开关资料与系列",
    lead: "Leaflet、参数表与操作说明。PDF 在国际站。",
    ctaDocs: "浏览资料",
    ctaProducts: "产品系列",
    ctaSelector: "选型",
    docsBandTitle: "技术资料",
    docsBandDesc: (n: number) =>
      `${n} 份 PDF — 简介、参数表、操作说明。资料页可按型号筛选。`,
    docsBandCta: "打开资料",
    seriesTitle: "产品系列",
    seriesCta: "全部系列",
    selectorStripTitle: "选型",
    selectorStripDesc: "按电压、电流对照型号。仅初筛。",
    selectorStripCta: "打开工具",
