...
const en = {
  ...
  home: {
    ...
    title: "Technical docs for tap-changer buyers",
    lead:
      "Product series, leaflets, data sheets, and operating manuals in one place. Unofficial reference for procurement and engineering.",
    ctaProducts: "Browse products",
    ctaDocs: "Open documents",
    ctaSelector: "Type selector",
    meta: (series: number, docs: number) =>
      `${series} series · ${docs} PDFs · files on official site`,
    entriesLabel: "Where to go",
    entryProductsTitle: "Product series",
    entryProductsDesc: "Oil, vacuum, dry-type OLTC, and motor drives by family.",
    entryProductsCta: "View catalogue",
    entryDocsTitle: "Technical documents",
    entryDocsDesc: (n: number) =>
      `${n} PDFs: leaflets, data sheets, and manuals on the official site.`,
    entryDocsCta: "Browse library",
    entrySelectorTitle: "OLTC selector",
    entrySelectorDesc: "Map voltage and current to a first-pass catalogue type.",
    entrySelectorCta: "Open tool",
    howTitle: "Suggested path",
...
const zh = {
  ...
  home: {
    ...
    title: "面向采购的分接开关技术资料",
    lead:
      "产品系列、Leaflet、参数表与操作说明集中查阅。非官方参考，供采购与工程使用。",
    ctaProducts: "浏览产品",
    ctaDocs: "打开资料库",
    ctaSelector: "选型工具",
    meta: (series: number, docs: number) =>
    ...
    entryProductsDesc: "油浸、真空、干式 OLTC 与电动机构，按系列归类。",
    entryProductsCta: "查看目录",
    entryDocsTitle: "技术资料",
    entryDocsDesc: (n: number) =>
      `${n} 份 PDF：简介、参数表与操作说明，文件在官网。`,
    entryDocsCta: "浏览资料库",
    entrySelectorTitle: "OLTC 选型",
    entrySelectorDesc: "按电压、电流做初筛型号对照。",
